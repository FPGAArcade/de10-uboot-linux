...
module soc_system_mm_interconnect_0 (
	...
	wire    [1:0] cmd_mux_src_channel;                                                        // cmd_mux:src_channel -> jtag_uart_avalon_jtag_slave_agent:cp_channel
	...
	wire    [1:0] cmd_mux_001_src_channel;                                                    // cmd_mux_001:src_channel -> sysid_qsys_control_slave_agent:cp_channel
	...
	wire  [101:0] fpga_only_master_master_agent_cp_data;                                      // fpga_only_master_master_agent:cp_data -> router:sink_data
	...
	wire  [101:0] jtag_uart_avalon_jtag_slave_agent_rp_data;                                  // jtag_uart_avalon_jtag_slave_agent:rp_data -> router_001:sink_data
	...
	wire  [101:0] router_src_data;                                                            // router:src_data -> fpga_only_master_master_limiter:cmd_sink_data
	wire          router_src_ready;                                                           // fpga_only_master_master_limiter:cmd_sink_ready -> router:src_ready
	wire    [1:0] router_src_channel;                                                         // router:src_channel -> fpga_only_master_master_limiter:cmd_sink_channel
	...
	wire  [101:0] fpga_only_master_master_limiter_cmd_src_data;                               // fpga_only_master_master_limiter:cmd_src_data -> cmd_demux:sink_data
	wire          fpga_only_master_master_limiter_cmd_src_ready;                              // cmd_demux:sink_ready -> fpga_only_master_master_limiter:cmd_src_ready
	wire    [1:0] fpga_only_master_master_limiter_cmd_src_channel;                            // fpga_only_master_master_limiter:cmd_src_channel -> cmd_demux:sink_channel
	...
	wire  [101:0] rsp_mux_src_data;                                                           // rsp_mux:src_data -> fpga_only_master_master_limiter:rsp_sink_data
	wire          rsp_mux_src_ready;                                                          // fpga_only_master_master_limiter:rsp_sink_ready -> rsp_mux:src_ready
	wire    [1:0] rsp_mux_src_channel;                                                        // rsp_mux:src_channel -> fpga_only_master_master_limiter:rsp_sink_channel
	...
	wire  [101:0] fpga_only_master_master_limiter_rsp_src_data;                               // fpga_only_master_master_limiter:rsp_src_data -> fpga_only_master_master_agent:rp_data
	...
	wire    [1:0] fpga_only_master_master_limiter_rsp_src_channel;                            // fpga_only_master_master_limiter:rsp_src_channel -> fpga_only_master_master_agent:rp_channel
	...
	wire    [1:0] fpga_only_master_master_limiter_cmd_valid_data;                             // fpga_only_master_master_limiter:cmd_src_valid -> cmd_demux:sink_valid
